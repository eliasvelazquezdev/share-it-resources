...
- [React y Redux Toolkit CRUD (con TailwindCSS) by Fazt](https://youtu.be/w2rAP7d6ndg?si=oR_QE0thjb55tYkh)
- [Redux Toolkit Query CRUD Tutorial - RTK Query by Fazt](https://youtu.be/A8gd1EWOCyA?si=4IPiva7AunuzMtZh)

### Teoría de React
- [The React Lifecycle: Simply Explained! by Cosden Solutions](https://youtu.be/kKVVan3EGoU?si=6IGHzOxI7RX6iLp5)
